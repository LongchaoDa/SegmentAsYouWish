...
organ_list_to_seg = [2, 3, 6] # the organs you want to segment, input is the label

Name_DIC = {
    'Spleen': 1,
    'I want to segment the Right Kidney': 2,
    'Please segment the Left Kidney in this CT scan': 3,
    'Gall Bladder':4,
    'Esophagus': 5, 
    'Where is the Liver located': 6,
    'Stomach': 7,
    'Arota': 8, 
    'Postcava': 9, 
