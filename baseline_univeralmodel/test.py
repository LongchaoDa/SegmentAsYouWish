...
# CUDA_VISIBLE_DEVICES=0 python -W ignore test.py --resume /home/local/ASURITE/longchao/Desktop/project/GE_health/CLIP-Driven-Universal-Model/pretrained_weights/swinunetr.pth --data_root_path /mnt/zzhou82/PublicAbdominalData/ --store_result --cache_dataset --cache_rate 0.6