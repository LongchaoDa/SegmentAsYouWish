...
model_path = "/home/ec2-user/textSegment/Proposal/MedSAM/extensions/text_prompt/eval/test_ckps/medsam_text_prompt_best_maxpool.pth"
...
# 设置图形标题和标签
ax.set_title(f'Max-pool Silhouette Score: {sil_score:.2f})')
...
# 保存图形
plt.savefig("/home/ec2-user/textSegment/Proposal/MedSAM/extensions/text_prompt/eval/save/pca_3d_maxpool_leftonly.png", dpi=400)
# plt.show()