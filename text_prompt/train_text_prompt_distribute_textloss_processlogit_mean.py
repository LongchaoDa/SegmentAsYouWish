...
parser.add_argument(
    '-work_dir',
    type=str,
    default="/home/ec2-user/textSegment/Proposal/MedSAM/text_prompt/train_text_prompt",
...
with open('/home/ec2-user/textSegment/Proposal/MedSAM/text_prompt/organ_labels.json', 'r') as file:
