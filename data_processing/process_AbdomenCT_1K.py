...
modality = "CT"
anatomy = "Abd1K"  # anantomy + dataset name
subset = "TestImage"
img_name_suffix = "_0000.nii.gz"
gt_name_suffix = ".nii.gz"
prefix = modality + "_" + anatomy + "_"

nii_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/AbdomenCT_1K/unzip/AbdomenCT_1K/{subset}/TrainImage"  # path to the nii images
gt_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/AbdomenCT_1K/unzip/AbdomenCT_1K/{subset}/TrainMask"  # path to the ground truth
# npy_path = "/home/ec2-user/SageMaker/data/npy/" + prefix[:-1] + f'/{subset}/'
npy_path = "/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/AbdomenCT_1K/npy/" + prefix[:-1] + f'/{subset}/'
