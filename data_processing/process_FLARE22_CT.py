...
nii_path = "unzip/FLARE22Train/images"  # path to the nii images
gt_path = "unzip/FLARE22Train/labels"  # path to the ground truth
npy_path = "npy/CT_Abd_test"
...
for name in tqdm(names[45:50]):  # use the remaining 10 cases for validation
