...
modality = "CT"
anatomy = "WORD"  # anantomy + dataset name
subset = "Val" # Tr Val
...
nii_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/WORD/unzip/WORD-V0.1.0/images{subset}"  # path to the nii images
gt_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/WORD/unzip/WORD-V0.1.0/labels{subset}"  # path to the ground truth
npy_path = "/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/WORD/npy/WORD-V0.1.0/" + prefix[:-1] + f'/{subset}/'
