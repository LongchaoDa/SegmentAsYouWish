...
modality = "CT"
anatomy = "MSD"  # anantomy + dataset name
subset = "Task10_Colon" 
...
# img = 'BRATS_001.nii.gz'
# gdt = 'BRATS_001.nii.gz'
nii_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/MSD/unzip/{subset}/imagesTr"  # path to the nii images
gt_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/MSD/unzip/{subset}/labelsTr"  # path to the ground truth
npy_path = "/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/MSD/npy/" + prefix[:-1] + f'/{subset}/'
...
names = [
    name
    for name in names
    if os.path.exists(join(nii_path, name.split(gt_name_suffix)[0] + img_name_suffix)) and not name.startswith(".")
]
