...
modality = "CT"
anatomy = "CHAOS"  # anantomy + dataset name
# subset = "Subtask2"
...
nii_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/CHAOS/unzip/nii/Train_Sets/CT/image"  # path to the nii images
gt_path = f"/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/CHAOS/unzip/nii/Train_Sets/CT/mask"  # path to the ground truth
npy_path = "/home/ec2-user/SageMaker/SegmentAsYouWish/text_prompt/data/touse/CHAOS/npy/" + prefix[:-1]
